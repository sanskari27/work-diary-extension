...
export const themes: Theme[] = [
	...
	},
	{
		id: 'green',
		name: 'Green',
		description: 'Fresh green theme with emerald accents',
		colors: {
			primary: '142 76% 36%',
			...
			accent: '160 84% 39%',
			accentForeground: '210 40% 98%',
			accentBorder: '142 50% 30%',
			gradientFrom: '142 100% 40%',
			gradientTo: '160 100% 40%',
			gradientShadow: '142 100% 40%',
			backgroundFrom: '222 47% 4.9%',
			backgroundVia: '142 50% 10%',
			backgroundTo: '222 47% 4.9%',
			backgroundIcon: '142 100% 40%',
			glassBorder: '142 50% 50%',
			glassBorderStrong: '142 50% 60%',
			scrollbarTrack: '142 50% 20%',
			scrollbarThumb: '142 50% 40%',
			scrollbarThumbHover: '142 50% 60%',
			textPrimary: '142 70% 60%',
			textSecondary: '142 50% 45%',
			textMuted: '142 30% 35%',
			textAccent: '142 76% 36%',
			textAccentForeground: '210 40% 98%',
			ring: '142 76% 36%',
		},
	},

...
const ReleaseEventDefaultsSection = () => {
	...
	return (
		<div className='space-y-6'>
			<div>
				<h3 className='text-xl font-semibold text-purple-300 mb-2'>Release Event Defaults</h3>
				<p className='text-sm text-slate-400 mb-4'>Set default values for new release events</p>
			</div>
			...
			<div className='space-y-6'>
				...
				<div className='glass rounded-xl p-5 border border-purple-500/20'>
					<div className='flex items-start gap-3'>
						...
						<div className='flex-1 space-y-3'>
							<div>
								<Label htmlFor='titlePrefix' className='text-purple-200 font-medium'>
				...
				<div className='glass rounded-xl p-5 border border-purple-500/20'>
					<div className='flex items-start gap-3'>
						...
						<div className='flex-1 space-y-3'>
							<div>
								<Label className='text-purple-200 font-medium'>Default Reminder Delta</Label>
								<p className='text-sm text-slate-400 mt-1'>
				...
				<div className='glass rounded-xl p-5 border border-purple-500/20'>
					<div className='flex items-start gap-3'>
						...
						<div className='flex-1 space-y-3'>
							<div>
								<Label className='text-purple-200 font-medium'>Default Element Sorting</Label>
								<p className='text-sm text-slate-400 mt-1'>

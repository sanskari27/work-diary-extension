			...
			<SidebarContext.Provider value={contextValue}>
				<TooltipProvider delayDuration={0}>
					<div
						...
						className={cn(
							'group/sidebar-wrapper flex min-h-svh w-full has-[[data-variant=inset]]:bg-background-gradient',
							className
						)}
						ref={ref}
						{...props}
	...
	(
		...
		if (collapsible === 'none') {
			return (
				<div
					className={cn(
						'flex h-full w-[--sidebar-width] flex-col bg-background-gradient text-foreground',
						className
					)}
					ref={ref}
					{...props}
			...
			return (
				<Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
					<SheetContent
						...
						data-mobile='true'
						className='w-[--sidebar-width] bg-background-gradient p-0 text-foreground [&>button]:hidden'
						style={
							{
		...
		return (
			...
			>
				...
				>
					<div
						data-sidebar='sidebar'
						className='flex h-full w-full flex-col bg-background-gradient group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-border group-data-[variant=floating]:shadow'
					>
						{children}
					</div>
				</div>
		...
		return (
			<button
				...
				className={cn(
					...
					'group-data-[collapsible=offcanvas]:translate-x-0 group-data-[collapsible=offcanvas]:after:left-full group-data-[collapsible=offcanvas]:hover:bg-background-gradient',
